function [realrho, pval]=pvalvsNull(readleft1,readright1,readleft2,readright2, ctlleft, ctlright, permno,wsname, v_exclude_left, v_exclude_right)
% NOTE: this script is modified from Aaron Alexander-Bloch & Siyuan Liu 
% (available at https://github.com/spin-test/spin-test)to accomodate 
% partial correlations with additional maps. Edits made by nrh
% July 2025. 
...
datal3(v_exclude_left, :) = NaN;
datar3(v_exclude_right, :) = NaN;

data1=cat(1,datal1,datar1);
data2=cat(1,datal2,datar2);
data3=cat(1, datal3, datar3);
...
realrho = partialcorr(data1, data2, data3, 'rows', 'complete');
